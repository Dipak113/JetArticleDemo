...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="JetArticleDemo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14JetArticleDemo11AppDelegate")
...
SWIFT_CLASS("_TtC14JetArticleDemo20ArticleTableViewCell")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified userDesignationLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified contentLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified articleNameLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified articleUrlLabel;
...
SWIFT_CLASS("_TtC14JetArticleDemo18BaseViewController")
...
SWIFT_CLASS("_TtC14JetArticleDemo22ArticlesViewController")
@interface ArticlesViewController : BaseViewController
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified articleTableView;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface ArticlesViewController (SWIFT_EXTENSION(JetArticleDemo)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC14JetArticleDemo17ArticlesViewModel")
...
SWIFT_CLASS("_TtC14JetArticleDemo10BlurLoader")
...
SWIFT_CLASS("_TtC14JetArticleDemo13SceneDelegate")
...
SWIFT_CLASS("_TtC14JetArticleDemo13ServerManager")
...
SWIFT_CLASS("_TtC14JetArticleDemo14ViewController")
